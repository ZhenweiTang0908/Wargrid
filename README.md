...
当前版本包含四人身份局、八张 9×9 战场（含西凉沙驿）、移动与寻路、基础牌/锦囊/装备、身份胜负和 AI 座次轮转。选将前可选择标准牌池（108 张，含 EX 牌）或扩展牌池（116 张，加入军争牌）；牌面配置参考[标准包牌表](https://wiki.biligame.com/sgs/标准包卡牌)。原创武将 3D 制作规范见 [docs/3d-art-direction.md](docs/3d-art-direction.md)。
