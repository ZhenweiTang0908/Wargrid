...
export const DESERT_OBSTACLES: Position[] = [
  { x: 2, y: 2 }, { x: 2, y: 3 }, { x: 2, y: 6 },
  { x: 6, y: 2 }, { x: 6, y: 5 }, { x: 6, y: 6 },
  { x: 1, y: 4 }, { x: 7, y: 4 },
]
export const DESERT_TERRAIN: Terrain[] = [
  ...terrainLine('road', [
    ...Array.from({ length: 9 }, (_, y) => ({ x: 4, y })),
    ...Array.from({ length: 7 }, (_, x) => ({ x: x + 1, y: 4 })),
  ]),
  ...terrainLine('ridge', [{ x: 3, y: 2 }, { x: 5, y: 2 }, { x: 3, y: 6 }, { x: 5, y: 6 }]),
  ...terrainLine('marsh', [{ x: 2, y: 4 }, { x: 6, y: 4 }, { x: 1, y: 5 }, { x: 7, y: 3 }]),
  ...terrainLine('water', [{ x: 0, y: 3 }, { x: 8, y: 5 }]),
  ...terrainLine('village', [{ x: 1, y: 1 }, { x: 7, y: 7 }]),
  ...terrainLine('watchtower', [{ x: 0, y: 4 }, { x: 8, y: 4 }]),
  ...terrainLine('camp', [{ x: 4, y: 0 }, { x: 4, y: 8 }]),
]
...
export const WINTER_OBSTACLES: Position[] = [
...
export const WINTER_TERRAIN: Terrain[] = [
  ...
  ...terrainLine('watchtower', [{ x: 1, y: 3 }, { x: 7, y: 5 }]),
  ...terrainLine('village', [{ x: 0, y: 6 }, { x: 8, y: 2 }]),
  ...terrainLine('camp', [{ x: 4, y: 0 }, { x: 4, y: 8 }]),
]
...
const desertObjects: MapObject[] = [
  { id: 'south-cache', position: { x: 3, y: 7 }, kind: 'supplyCache', claimed: false },
  { id: 'north-cache', position: { x: 5, y: 1 }, kind: 'supplyCache', claimed: false },
  { id: 'west-shrine', position: { x: 0, y: 3 }, kind: 'healingShrine', claimed: false },
  { id: 'east-shrine', position: { x: 8, y: 5 }, kind: 'healingShrine', claimed: false },
  { id: 'west-beacon', position: { x: 0, y: 7 }, kind: 'scoutBeacon', claimed: false },
  { id: 'east-beacon', position: { x: 8, y: 1 }, kind: 'scoutBeacon', claimed: false },
]
...
const winterObjects: MapObject[] = [
  { id: 'south-cache', position: { x: 5, y: 7 }, kind: 'supplyCache', claimed: false },
  { id: 'north-cache', position: { x: 5, y: 1 }, kind: 'supplyCache', claimed: false },
  { id: 'west-shrine', position: { x: 0, y: 5 }, kind: 'healingShrine', claimed: false },
  { id: 'east-drum', position: { x: 8, y: 3 }, kind: 'warDrum', claimed: false },
  { id: 'west-beacon', position: { x: 0, y: 2 }, kind: 'scoutBeacon', claimed: false },
  { id: 'east-beacon', position: { x: 8, y: 7 }, kind: 'scoutBeacon', claimed: false },
]
...
export function createInitialState(deck?: Card[], randomizeIdentities = false, random = Math.random, mapId: MapId = 'river', deckMode: DeckMode = 'standard'): GameState {
  ...
  const state: GameState = {
    ...
    chainTargets: [], reachable: [], pathPreview: [], pendingResponse: null, pendingHarvest: null, pendingFanjian: null, pendingPlunder: null, pendingJudgement: null, pendingLuoshen: null, pendingGuanxing: null, pendingTuxi: null, pendingLuoyi: null, pendingGreenDragon: null, pendingLiuli: null, pendingAxe: null, pendingIceSword: null, pendingHalberd: null, pendingQilin: null, pendingYiji: null, pendingTurnStart: null, winner: null, message: '出牌阶段 · 移动或使用手牌', history: ['战局开始'],
  }
