...
export function createInitialState(deck = createDeck()): GameState {
  const state: GameState = {
    ...
    units: {
      player: { id: 'player', name: '关羽', title: '美髯公', team: 'player', identity: 'lord', faction: 'shu', revealed: true, position: { x: 4, y: 8 }, hp: 5, maxHp: 5, hand: deck.slice(0, 4), equipment: {}, judgement: [], skill: 'wusheng', movement: 3, attacksUsed: 0, wineUsed: false, drunk: false, chained: false, skillUsed: false, animation: 'idle' },
      north: { id: 'north', name: '赵云', title: '少年将军', team: 'north', identity: 'loyalist', faction: 'shu', revealed: false, position: { x: 4, y: 0 }, hp: 4, maxHp: 4, hand: deck.slice(4, 8), equipment: {}, judgement: [], skill: 'longdan', movement: 3, attacksUsed: 0, wineUsed: false, drunk: false, chained: false, skillUsed: false, animation: 'idle' },
      east: { id: 'east', name: '夏侯惇', title: '独眼的罗刹', team: 'east', identity: 'rebel', faction: 'wei', revealed: false, position: { x: 8, y: 4 }, hp: 4, maxHp: 4, hand: deck.slice(8, 12), equipment: {}, judgement: [], skill: 'ganglie', movement: 3, attacksUsed: 0, wineUsed: false, drunk: false, chained: false, skillUsed: false, animation: 'idle' },
      west: { id: 'west', name: '司马懿', title: '狼顾之鬼', team: 'west', identity: 'renegade', faction: 'wei', revealed: false, position: { x: 0, y: 4 }, hp: 4, maxHp: 4, hand: deck.slice(12, 16), equipment: {}, judgement: [], skill: 'feedback', movement: 3, attacksUsed: 0, wineUsed: false, drunk: false, chained: false, skillUsed: false, animation: 'idle' },
    },
