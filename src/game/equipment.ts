...
export function resolveEquipmentLoss(unit: Unit, lost: Card[], deck: Card[], discard: Card[]) {
  ...
  const draw = drawCount ? drawCards(deck, discard, drawCount) : { drawn: [] as Card[], deck, discard }
